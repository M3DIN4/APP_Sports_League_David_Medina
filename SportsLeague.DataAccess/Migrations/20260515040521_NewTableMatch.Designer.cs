...
namespace SportsLeague.DataAccess.Migrations
{
    ...
    [Migration("20260515040521_NewTableMatch")]
            ...
            modelBuilder.Entity("SportsLeague.Domain.Entities.Match", b =>
                {
                    ...
                    b.Property<int?>("TournamentTeamId1")
                        .HasColumnType("int");

                    b.Property<int?>("TournamentTeamId2")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TournamentTeamId1");

                    b.HasIndex("TournamentTeamId2");
            ...
            modelBuilder.Entity("SportsLeague.Domain.Entities.Match", b =>
                {
                    ...
                    b.HasOne("SportsLeague.Domain.Entities.TournamentTeam", null)
                        .WithMany("AwayMatches")
                        .HasForeignKey("TournamentTeamId");

                    b.HasOne("SportsLeague.Domain.Entities.TournamentTeam", null)
                        .WithMany("HomeMatches")
                        .HasForeignKey("TournamentTeamId1");

                    b.HasOne("SportsLeague.Domain.Entities.TournamentTeam", null)
                        .WithMany("Matches")
                        .HasForeignKey("TournamentTeamId2");
